...
C_SRCS += \
C:/Workspaces/KDS/FSL_Kinetis_Bootloader_1_2_0_KS22_1_0_0/src/usb_stack/usb_core/device/sources/classes/common/usb_class.c 

OBJS += \
./src/usb_stack/usb_core/device/sources/classes/common/usb_class.o 

C_DEPS += \
./src/usb_stack/usb_core/device/sources/classes/common/usb_class.d 


# Each subdirectory must supply rules for building sources it contributes
src/usb_stack/usb_core/device/sources/classes/common/usb_class.o: C:/Workspaces/KDS/FSL_Kinetis_Bootloader_1_2_0_KS22_1_0_0/src/usb_stack/usb_core/device/sources/classes/common/usb_class.c
	@echo 'Building file: $<'
