...
C_SRCS += \
C:/Workspaces/KDS/FSL_Kinetis_Bootloader_1_2_0_KS22_1_0_0/src/usb_stack/usb_core/device/sources/controller/ehci/ehci_dev_main.c 

OBJS += \
./src/usb_stack/usb_core/device/sources/controller/ehci/ehci_dev_main.o 

C_DEPS += \
./src/usb_stack/usb_core/device/sources/controller/ehci/ehci_dev_main.d 


# Each subdirectory must supply rules for building sources it contributes
src/usb_stack/usb_core/device/sources/controller/ehci/ehci_dev_main.o: C:/Workspaces/KDS/FSL_Kinetis_Bootloader_1_2_0_KS22_1_0_0/src/usb_stack/usb_core/device/sources/controller/ehci/ehci_dev_main.c
	@echo 'Building file: $<'
